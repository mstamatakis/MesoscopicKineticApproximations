...
%[0 100 255]/255; % FOR PLOTTING: color
...
ApproxColor{kAppr} = [255 200 0]/255; % FOR PLOTTING: color
%[0 200 255]/255; % FOR PLOTTING: color
ApproxMarkr{kAppr} = 'o'; % FOR PLOTTING: marker
ApproxLinSpec{kAppr} = '-'; % FOR PLOTTING: line type
ApproxMSize(kAppr) = 6; % FOR PLOTTING: marker size
end
...
load('Main_GeneralisedCompar_CHEMREACTOR22_MiguelK2T680_vMFdens.mat')
...
if compareMC
 ...
 %   plot(logconvc*0.2,7.949052e-01,'>','Color',[0 0 0],'MarkerFaceColor','None','MarkerSize',6)
    plot(logconvc*0.2,1.786939e-01,'^','Color',[200 100 0]/255,'MarkerFaceColor','None','MarkerSize',6)
    plot(logconvc*0.2,-1.641416e+00,'o','Color',[255 200 0]/255,'MarkerFaceColor','None','MarkerSize',6)
    NetRateGCMC = exp(M(:,2).');
...
text(-1.8,5.9,'(e)','FontSize',30)
%text(4.342945e-02,5.372262e-01,'>','FontSize',12)
%text(4.342945e-02,-8.573918e-02,'>','FontSize',12)
%text(4.342945e-02,-1.920131e+00,'>','FontSize',12)
eval(['print -dpng TOFvsRatioK2T680']);
eval(['print -depsc Fig5e']);
...
text(-1.8,1.1,'(d)','FontSize',30)
eval(['print -dpng ThetaVsNO2NORatioK2T680']);
eval(['print -depsc ThetaVsNO2NORatioK2T680']);
