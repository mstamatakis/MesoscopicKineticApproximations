function out1 = HamiltonianK3NN1corr(H0,H1,h,nn,g1,epsl)
...
out1 = H0 + H1*epsl(:,1) + ... % central site 1-body term
    ...
    (H1)*sum(epsl(:,8:13),2) + ... % 2NN sites, 1-body + effective field
    (H1+g1)*sum(epsl(:,14:19),2) + ... % 3NN sites, 1-body + effective field
