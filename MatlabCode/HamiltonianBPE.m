function out1 = HamiltonianBPE(H0,H1,h,nn,g1,epsl)

% Implementation of the Hamiltonian of Bethe-Peiers with edge interactions 
% epsl is the state vector. Teh energy of the microstate is returned (out1)
...
EdgeInter = h*epsl(:,2).*epsl(:,nn+1);
for i = 2:nn
    EdgeInter = EdgeInter + h*epsl(:,i).*epsl(:,i+1);
end
