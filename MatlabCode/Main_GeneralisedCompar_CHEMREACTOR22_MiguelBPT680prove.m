...
ApproxLinSpec{kAppr} = ''; % FOR PLOTTING: line type
ApproxMSize(kAppr) = 9; % FOR PLOTTING: marker size
%if 0
...
if compareMC
 ...
 %   plot(logconvc*0.2,7.949052e-01,'>','Color',[0 0 0],'MarkerFaceColor','None','MarkerSize',6)
    plot(logconvc*0.2,-2.573523e-01,'^','Color',[200 100 0]/255,'MarkerFaceColor','None','MarkerSize',8)
    plot(logconvc*0.2,1.931566e-01,'d','Color',[0 0 255]/255,'MarkerFaceColor','None','MarkerSize',9)
    plot(logconvc*0.2,1.786939e-01,'o','Color',[255 200 0]/255,'MarkerFaceColor','None','MarkerSize',8)
