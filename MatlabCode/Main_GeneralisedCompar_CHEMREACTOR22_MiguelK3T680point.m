...
ApproxName{kAppr} = 'WMF'; % name of the approximation
...
% % Next the K3NNC1 approximation
 ...
 gcguess{kAppr} = 1*[0.1165  0.2745   0.3094   0.0524   -0.0310   0.1431  -0.0441]; % guess values for parameters (row vector)
...
eval(['print -depsc TOFvsRatioK3T680']);
