...
% CorrelAll = {1, 2, 4, 7};
% CorrelAll = {[1 2], [4 5],[8 14],[18 12],[11 6],[1 5]};
% CorrelAll = {[1 8],[2 6],[1 11],[6 19],[9 10]};
% CorrelAll = {[1 14], [3 6], [1 18],[7 8],[19 18],[16 1],[13 6]};
% CorrelAll = {[9 14], [9 6], [4 18]};
% CorrelAll = {[1 2 3], [1 4 5], [2 3 8], [6 7 12], [2 14 8], [6 11 18]};
% 
% [PFcn,PFcnEps1_Z,PFcnEps0_Z,PFcnPartial] = ...
%     PartitionFunction_BruteForce(ApproxName{k},...
%     CorrelAll,...
%     nsites{k},beta,H0(k),H1,h,nn,muOstar,gcsolnCell{:});
% 
% PFcnPartial.'
...
[PFcn,gcsolnT,muOstar,CorrelOccup,CorrelUnocc, ...
    ...
    H0(k),H1,...
    STheta,h,nn,ZPEO,QvibO,ApproxName{k},...
    CorrelLHS{k},CorrelRHS{k},nsites{k},muOstar+0.02,gcguess{k},options);
