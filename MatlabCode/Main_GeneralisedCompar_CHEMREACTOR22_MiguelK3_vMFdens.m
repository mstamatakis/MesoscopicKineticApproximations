...
load('Main_GeneralisedCompar_CHEMREACTOR22_MiguelK3_vMFdens.mat')
...
text(-1.8,5.9,'(c)','FontSize',30)  
eval(['print -dpng TOFvsRatioK3']);
eval(['print -depsc Fig5c']);
...
eval(['print -dpng ThetaVsNO2NORatioK3']);
eval(['print -depsc ThetaVsNO2NORatioK3']);
