...
Temp = 480; % Kelvin
Temp0 = Temp; % Kelvin
% Temp0 = 480; % Kelvin - If you want to evaluate the kinetic constants at Temp0 and the approximation solution to another
...
[EnrgGasSpecies,QvibO,ZPEO,...
    ...
    EnergeticsAndKineticsTlnPr(Temp0,3,-4);
...
for i = 1:length(logyNO2yNOrange);
    ...
    [EnrgGasSpecies,QvibO,ZPEO,...
        ...
        ApreOdiff,PERatioOdiff,EaOdiff,ProxFacOdiff,ApreOdiff_sc,...
        ApreNOoxi,PERatioNOoxiNO2red,EaNOoxi,ProxFacNOoxi,ApreNOoxi_sc] = ...
        EnergeticsAndKineticsTlnPr(Temp0,nFigs,logyNO2yNO);
