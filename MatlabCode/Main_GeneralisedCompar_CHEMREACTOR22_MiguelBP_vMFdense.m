...
load('Main_GeneralisedCompar_CHEMREACTOR22_MiguelBP_vMFdense.mat')
...
text(0.0,6.0,'T=480 K','FontSize',30) 
text(-1.8,5.9,'(a)','FontSize',30) 
eval(['print -dpng TOFvsRatioBP']);
eval(['print -depsc2 Fig5a']);
...
eval(['print -dpng ThetaVsNO2NORatioBP']);
eval(['print -depsc coveragrVsNO2NORatioBP']);
