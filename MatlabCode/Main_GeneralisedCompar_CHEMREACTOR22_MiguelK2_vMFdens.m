...
load('Main_GeneralisedCompar_CHEMREACTOR22_MiguelK2_vMFdens.mat')
...
text(-1.8,5.9,'(b)','FontSize',30) 
eval(['print -dpng TOFvsRatioK2']);
eval(['print -depsc Fig5b']);
...
eval(['print -dpng ThetaVsNO2NORatioK2']);
eval(['print -depsc ThetaVsNO2NORatioK2']);
