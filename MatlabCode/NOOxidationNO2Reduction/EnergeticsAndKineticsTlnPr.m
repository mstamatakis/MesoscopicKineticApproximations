...
ApreOdiff = 100*kboltz*Temp/hplanck;
PERatioOdiff = 1.0;
EaOdiff = 0.100;
ProxFacOdiff = 0.500;
...
ApreNOoxi = 100*1.5e+7*kboltz*Temp/hplanck/QvibO*exp((1/2*EO2gasRef+ZPEO)/(kboltz*Temp));
...
if (Temp == 480)
    ...
    if logyNO2yNO < logyNO2yNO_equil % on the left of the equilibrium point
        ...
        ApreNOoxi_1 = 1.000e+18;
        ApreNOoxi_2 = 3.000e+15;
        logyNO2yNO_1 = -4.0;
        logyNO2yNO_2 = 4.0;
        ...
        ApreOdiff_1 = 2.000e+07;
        ApreOdiff_2 = 3.000e+01;
        logyNO2yNO_1 = -4.0;
        logyNO2yNO_2 = 2.0;
        ...
        ApreNOoxi_1 = 5.000e+15;
        ApreNOoxi_2 = 1.000e+16;
        logyNO2yNO_1 = 5.0;
        logyNO2yNO_2 = 8.0;
        ...
        ApreOdiff_1 = 2.000e+01;
        ApreOdiff_2 = 4.000e+01;
        logyNO2yNO_1 = 4.5;
        logyNO2yNO_2 = 8.0;
...
elseif (Temp == 680)
    ...
    if logyNO2yNO < logyNO2yNO_equil % on the left of the equilibrium point
        ...
        ApreNOoxi_1 = 3.369750827903273e+019*125;
        ApreNOoxi_2 = 1.072301532145342e+011*125;
        logyNO2yNO_1 = -4.0;
        logyNO2yNO_2 = 8.0;
...
% ApreNOoxi_sc = 10*ApreNOoxi_sc;
% ApreOdiff_sc = 10*ApreOdiff_sc;
