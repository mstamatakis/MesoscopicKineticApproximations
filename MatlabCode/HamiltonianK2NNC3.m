function out1 = HamiltonianK2NNC3(H0,H1,h,nn,g1,g2,c1,c2,p1,p2,p3,epsl)
...
EdgeInterP11 = p1* ( ...
    epsl(:,2).*epsl(:,4) + epsl(:,2).*epsl(:,6) + ...
    epsl(:,3).*epsl(:,5) + epsl(:,3).*epsl(:,7) + ...
    epsl(:,4).*epsl(:,6) + ...
    epsl(:,5).*epsl(:,7) ...
...
EdgeInterP12 = p3* ( ...
    epsl(:,2).*epsl(:,9)  + epsl(:,2).*epsl(:,12) + ...
    epsl(:,3).*epsl(:,10) + epsl(:,3).*epsl(:,13) + ...
    epsl(:,4).*epsl(:,8)  + epsl(:,4).*epsl(:,11) + ...
    epsl(:,5).*epsl(:,9)  + epsl(:,5).*epsl(:,12) + ...
    epsl(:,6).*epsl(:,10) + epsl(:,6).*epsl(:,13) + ...
    epsl(:,7).*epsl(:,8)  + epsl(:,7).*epsl(:,11) ...
    ); % 1NN-2NN 3rd nearest neighbor 2-body effective interactions

% Sum up all terms:
out1 = out1 + EdgeInter1 + EdgeInter12 + EdgeInterP11 + EdgeInterP22 + EdgeInterP12;
