MODULE nrutil
	...
	END INTERFACE
	! Routines for skew operations on matrices (unit matrix, lower triangle, upper triangle not
	...
	! Routines for “outer” operations on vectors. The order convention is: result(i,j) = first operand(i)
	! (op) second operand(j).
