subroutine approx_initialise_3NN(obj_approx)
	...
	class (approximation) :: obj_approx
       ...
       interface
           subroutine  sigma1_sigma2_3NN(obj_approx)
        ...
        interface
           subroutine  sigma1_sigma8_3NN(obj_approx)
               import approximation
               class(approximation) :: obj_approx
           end subroutine
        end interface
        ...
        interface
           subroutine  sigma1_sigma14_3NN(obj_approx)
               import approximation
               class(approximation) :: obj_approx
           end subroutine
        end interface
                ...
                interface
           subroutine  sigma1sigma2_sigma2sigma3_3NN(obj_approx)
               import approximation
               class(approximation) :: obj_approx
           end subroutine
        end interface
        ...
        interface
           subroutine  sigma1sigma2_sigma2sigma8_3NN(obj_approx)
               import approximation
               class(approximation) :: obj_approx
           end subroutine
        end interface
       ...
       interface
           subroutine  sigma1sigma2_sigma2sigma14_3NN(obj_approx)
               import approximation
               class(approximation) :: obj_approx
           end subroutine
        end interface
       ...
       interface
           subroutine  sigma1sigma2_sigma8sigma14_3NN(obj_approx)
               import approximation
               class(approximation) :: obj_approx
           end subroutine
        end interface
        ...
        interface
           subroutine  sigma1sigma8_sigma2sigma4_3NN(obj_approx)
               import approximation
               class(approximation) :: obj_approx
           end subroutine
        end interface
        ...
        interface
           subroutine  sigma1sigma8_sigma8sigma9_3NN(obj_approx)
               import approximation
               class(approximation) :: obj_approx
           end subroutine
        end interface
        ...
        interface
           subroutine  sigma1sigma8_sigma3sigma14_3NN(obj_approx)
               import approximation
               class(approximation) :: obj_approx
           end subroutine
        end interface
	...
	allocate(obj_approx%hamilt%origpars(0:norig),source=0.d0)
        allocate(int_values(0:norig), source = cal_parser%get_int_values()) ! value of an original interaction term in the Hamiltonian
        do i = 1, norig
            obj_approx%hamilt%origpars(i) = int_values(i)
        enddo!
	...
	do i = 1,nsites
        ...
        do i = 1,cal_parser%get_n_int()
            ntm = ntm + 1
            obj_approx%hamilt%interaction(ntm,1:2) = int_term(i,1:2) ! two body terms
            obj_approx%hamilt%internbody(ntm) = 2
        enddo

        if (cal_parser%get_cluster_depth().eq.'3NN') then ! for the momment it is not really needed
	...
	! Integer arrays to be used as pointers to terms and corrections:
            ...
            do i = 1,norig
                ...
                elseif (orig_names(i).eq.'1NN') then
                    if ((ncorc.eq.3).or.(ncorc.eq.7)) then 
                        obj_approx%hamilt%origterms(nsites+1:nterms) = 2
                    elseif (ncorc.gt.7) then
	     ...
	     allocate(obj_approx%eqns%corrlvalue(obj_approx%eqns%nterms),source = 0.d0) ! all correlation values initialised to zero
            ...
            if (ncorc.eq.3) then  ! SB or SBWI      
                call sigma1_sigma2_3NN(obj_approx)
                call sigma1_sigma8_3NN(obj_approx)
                call sigma1_sigma14_3NN(obj_approx)
            elseif (ncorc.eq.7) then ! SB plus 1NN		
                call sigma1_sigma2_3NN(obj_approx)
                call sigma1_sigma8_3NN(obj_approx)
                call sigma1_sigma14_3NN(obj_approx)
                call sigma1sigma2_sigma2sigma3_3NN(obj_approx)           
                call sigma1sigma2_sigma2sigma8_3NN(obj_approx)          
                call sigma1sigma2_sigma2sigma14_3NN(obj_approx)            
                call sigma1sigma2_sigma8sigma14_3NN(obj_approx)              
            elseif (ncorc.eq.10) then !SB plus 1NN and ghost 2NN
                call sigma1_sigma2_3NN(obj_approx)           
                call sigma1_sigma8_3NN(obj_approx)
                call sigma1_sigma14_3NN(obj_approx)
                call sigma1sigma2_sigma2sigma3_3NN(obj_approx)         
                ...
                call sigma1sigma2_sigma2sigma14_3NN(obj_approx)           
                call sigma1sigma2_sigma8sigma14_3NN(obj_approx) 
                call sigma1sigma8_sigma2sigma4_3NN(obj_approx)
                call sigma1sigma8_sigma8sigma9_3NN(obj_approx)            
                call sigma1sigma8_sigma3sigma14_3NN(obj_approx)   
            endif 
        endif

        return

end subroutine approx_initialise_3NN
...
subroutine sigma1_sigma2_3NN(obj_approx)
        ...
        return          
end subroutine sigma1_sigma2_3NN
...
subroutine sigma1_sigma8_3NN(obj_approx)
        ...
        return          
end subroutine sigma1_sigma8_3NN
...
subroutine sigma1_sigma14_3NN(obj_approx)
        ...
        obj_approx%eqns%rhs(3) = 4 ! and finally we encode the equatio 

        return          
end subroutine sigma1_sigma14_3NN
...
subroutine sigma1sigma2_sigma2sigma3_3NN(obj_approx)
        ...
        return          
end subroutine sigma1sigma2_sigma2sigma3_3NN
...
subroutine sigma1sigma2_sigma2sigma8_3NN(obj_approx)
        ...
        return          
end subroutine sigma1sigma2_sigma2sigma8_3NN
...
subroutine sigma1sigma2_sigma2sigma14_3NN(obj_approx)
        ...
        return          
end subroutine sigma1sigma2_sigma2sigma14_3NN
...
subroutine sigma1sigma2_sigma8sigma14_3NN(obj_approx)
        ...
        return          
end subroutine sigma1sigma2_sigma8sigma14_3NN
...
subroutine sigma1sigma8_sigma2sigma4_3NN(obj_approx)
        ...
        return          
end subroutine sigma1sigma8_sigma2sigma4_3NN
...
subroutine sigma1sigma8_sigma8sigma9_3NN(obj_approx)
        ...
        return          
end subroutine sigma1sigma8_sigma8sigma9_3NN
...
subroutine sigma1sigma8_sigma3sigma14_3NN(obj_approx)
        ...
        return          
end subroutine sigma1sigma8_sigma3sigma14_3NN
